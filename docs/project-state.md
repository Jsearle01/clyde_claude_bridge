...
### In progress
- T-P2-008.5 — Extension `.vsix` bundling fix via esbuild (COMPLETE, awaiting verdict)
...
- AC-24 retry — claude.ai → delegation → approval modal → all three button paths now unblocked by T-P2-008.5's bundling fix; operator-side confirmation
