...
### In progress
- T-P2-008.6 — CLAUDE_BRIDGE_DEBUG diagnostic instrumentation for C-29 (COMPLETE, awaiting verdict)
...
- C-29 fix task — informed by operator runtime smoke captured from T-P2-008.6 diagnostic output (blocks AC-24)
- AC-24 retry — blocked on C-29 fix; diagnostic instrumentation (T-P2-008.6) is prerequisite for fix-task scoping
