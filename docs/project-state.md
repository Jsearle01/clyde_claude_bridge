...
### In progress
- T-P2-003 — Phase 3 workspace registration + trust prompt + workspaces.json store (COMPLETE, awaiting verdict)

### Pending
- T-P2-004 — Phase 4 daemon-lifecycle commands ("Start Daemon" palette command; SecretStorage API key)
