...
### In progress
- T-P2-005 — Phase 5 daemon-not-running detection UX + actionable retry notification (COMPLETE, awaiting verdict)

### Pending
- T-P2-006 — Phase 6 status bar item showing workspace identifier + daemon state
