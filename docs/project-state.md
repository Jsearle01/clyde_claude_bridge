...
### In progress
- T-P2-006.5 — Field-vs-state-ordering fix in WorkspaceRegistration (COMPLETE, awaiting verdict)

### Pending
- T-P2-006-followup — small housekeeping task: promote "settable single-subscriber callback field" pattern to `docs/patterns/project/settable-single-subscriber-callback.md` (third confirmed use logged at T-P2-006; field-vs-setState invariant from C-26 must be incorporated)
- T-P2-008 — Phase 8 approval flow on delegation (daemon-side gate; extension-side modal)
