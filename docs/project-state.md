...
### In progress
- T-P2-007.5 — Windows path case-insensitivity at workspace registry lookup (COMPLETE, awaiting verdict)

### Pending
- T-P2-006-followup — small housekeeping task: promote "settable single-subscriber callback field" pattern to `docs/patterns/project/settable-single-subscriber-callback.md` (third confirmed use logged at T-P2-006)
